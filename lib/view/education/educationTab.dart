...
class EducationTab extends ConsumerStatefulWidget {
  const EducationTab({Key? key}) : super(key: key);

  @override
  ConsumerState<EducationTab> createState() => _EducationTabState();
}

class _EducationTabState extends ConsumerState<EducationTab> {
  @override
