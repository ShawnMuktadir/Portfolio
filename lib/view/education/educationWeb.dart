...
class EducationWeb extends ConsumerStatefulWidget {
  const EducationWeb({Key? key}) : super(key: key);

  @override
  ConsumerState<EducationWeb> createState() => _EducationWebState();
}

class _EducationWebState extends ConsumerState<EducationWeb> {
  @override
